...
function runPictureDialog(entries, pos, mediaType) {
    ...
    function bodyKeyDown(e) {
        switch (e.which) {
            ...
            case 38: /* Up */
                if (motioneyePlayer.currentTime > motioneyePlayer.duration - 10) {
                    motioneyePlayer.currentTime = motioneyePlayer.duration
                } else {
                    motioneyePlayer.currentTime += 10;
                }
                break;

            case 40: /* Dn */
                if (motioneyePlayer.currentTime < 10) {
                    motioneyePlayer.currentTime = 0
                } else {
                    motioneyePlayer.currentTime -= 10;
                }
                break;
