...
%/motioneye.po: motioneye/locale/motioneye.pot
	...
	l10n_scripts/traduki_po.sh $@

motioneye/static/js/motioneye.%.json : motioneye/locale/%/LC_MESSAGES/motioneye.js.po
		l10n_scripts/po2json motioneye/locale/$*/LC_MESSAGES/motioneye.js.po motioneye/static/js/motioneye.$*.json
...
motioneye/locale/motioneye.pot : motioneye/*.py motioneye/templates/*.html
	pybabel extract -F l10n_scripts/babel.cfg -o motioneye/locale/motioneye.pot .
#####
...
init%:
	...
	l10n_scripts/traduki_po.sh motioneye/locale/$*.js.tmp
	...
	l10n_scripts/traduki_po.sh motioneye/locale/$*.tmp
...
traduki :
	find motioneye/locale -name "*.po" -exec l10n_scripts/traduki_po.sh {} \;
